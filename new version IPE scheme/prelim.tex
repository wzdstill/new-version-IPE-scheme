...
We recall the syntax and security definition of \emph{inner product encryption} (IPE) \leo{cite}. IPE can be regarded as a generalization of predicate encryption. An IPE scheme $\Pi$ consists of the 4-tuple $(\setup, \keygen, \enc,
\\
